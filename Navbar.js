    ...
    <>
      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-sm shadow-lg' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2"> {/* Use flexbox and reduce space between */}
  <DotLottieReact
    src="https://lottie.host/ba5711fa-21fb-44fa-b605-3296ad599de0/tMUg2XsGtc.lottie"
    className="w-22 h-20" // Adjust the size as needed
    loop
    autoplay
  />
  <h1 className="font-extrabold text-transparent text-2xl bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-red-500">
    NeoViz
  </h1>
</div>
